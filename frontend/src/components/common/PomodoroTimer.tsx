...
const MODE_COLORS: Record<TimerMode, string> = {
  work: 'from-blue-600 to-blue-500',
  break: 'from-blue-500 to-cyan-500',
  longBreak: 'from-sky-600 to-blue-500',
};
  ...
  return (
    <div className="relative z-[200]">
      ...
      <motion.div
        ...
        className="bg-white border border-blue-200 p-3 rounded-xl shadow-sm cursor-pointer"
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-blue-700 text-[10px] uppercase tracking-wider">
              {MODE_LABELS[mode]}
            </p>
          </div>
      ...
      {showSettings && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-20 left-1/2 -translate-x-1/2 w-72 bg-white border border-blue-200 rounded-xl p-4 shadow-sm z-[9999]"
          >
          ...
          <button
            onClick={skipMode}
            className="w-full py-2 bg-white hover:bg-blue-50 rounded-lg text-sm text-blue-800 transition border border-blue-200"
          >
            Skip to Next
          </button>
          ...
          <div className="mt-4 pt-4 border-t border-blue-100 text-center">
            <p className="text-xs text-blue-700">
              Completed Sessions: <span className="text-blue-900 font-bold">{completedSessions}</span>
            </p>
          </div>
        </motion.div>
        </>
