# 🧠 AI Study Tutor (Notewise)

> AI-Powered Study Tutor Application with Retrieval-Augmented Generation (RAG) for document analysis and conversational learning.
